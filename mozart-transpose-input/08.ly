...
{
  r8  f'[ a' f' c'' f'] |						% bar 1
   f''[ e''16 d'']  c''[ d'' c'' bes']  a'[ bes' a' g'] |				% bar 2
   f'8[ a' c'' a' f'' c''] |						% bar 3
   a''16[ c''' bes'' c''']  a''16[ c''' bes'' c''']  a''16[ c''' bes'' c'''] |			% bar 4
   f''[ a'' g'' a'']  f''[ a'' g'' a'']  f''[ a'' g'' a''] |				% bar 5
   d''[ f'' e'' f'']  d''[ f'' e'' f'']  d''[ f'' e'' f''] |				% bar 6
   b'8[ g' d'' b' f'' d''] |						% bar 7
   g''16[ a'' g'' f'']  e''[ f'' e'' d'']  c''[ d'' c'' bes'!] |				% bar 8
   a'8[ d''16 c'']  b'[ c'' b' a']  g'[ a' g' f'] |				% bar 9
   e'[ f' e' d']  c'8[ c''16 b' c''8 e'] |					% bar 10
   f'[ c'' e' c'' d' b'] |						% bar 11
  c''4 r r |							% bar 12
  r8  c''[ e'' c'' g'' c''] |						% bar 13
   c'''[ b''16 a'']  g''[ a'' g'' f'']  e''[ f'' e'' d''] |				% bar 14
   c''[ bes'! c'' a'']  c''[ a'' bes' a'']  c''[ a'' a' a''] |			% bar 15
   bes'8[ g' bes' g' d'' g'] |					% bar 16
   g''[ f''16 es'']  d''[ es'' d'' c'']  bes'[ c'' bes' a'] |			% bar 17
   g'8[ bes' d'' bes' g'' d''] |						% bar 18
   bes''[ cis'' bes'' cis'' bes'' cis''] |				% bar 19
   d''[ a' f'' d'' a'' f''] |						% bar 20
   g''16[ f'' g'' bes'']  c''[ bes'' d'' bes'']  e''[ bes'' c'' bes''] |		% bar 21
   f''[ e'' f'' a'']  b'[ a'' cis'' a'']  d''[ a'' b' a''] |			% bar 22
   e''[ d'' e'' g'']  a'[ g'' b' g'']  cis''[ g'' a' g''] |			% bar 23
   f''8[ d'' bes'! d'' g' f''] |						% bar 24
   e''[ c'' a' c'' f' es''] |						% bar 25
   d''16[ f'' es'' f'']  d''[ f'' es'' f'']  d''[ f'' es'' f''] |			% bar 26
   bes'[ d'' c'' d'']  bes'[ d'' c'' d'']  bes'[ d'' c'' d''] |			% bar 27
   g'[ bes' a' bes']  g'[ bes' a' bes']  g'[ bes' a' bes'] |			% bar 28
   e'8[ c' g' e' bes' g'] |						% bar 29
   c''16[ d'' c'' bes']  a'[ bes' a' g']  f'[ g' f' es'] |			% bar 30
   d'8[ g'16 f']  e'[ f' e' d']  c'[ d' c' bes] |				% bar 31
   a[ bes a g]  f8[ f'16 e' f'8 a] |				% bar 32
...
voicetwo =  
{
  r2. |								% bar 1
  r8  f[ a f c' f]                                              % bar 2
   f'8[ e'16 d']  c'[ d' c' bes]  a[ bes a g] |                         % bar 3
   ...
   g8[ c'16 b]  a[ b a g]  f[ g f e] |                              % bar 10
   d[ e d c]  g[ f e f]  g8[ g,] |                                % bar 11
  r  c[ e c g c] |                                             % bar 12
   c'[ b16 a]  g[ a g f]  e[ f e d] |                              % bar 13
   c8[ e g e c' g] |                                             % bar 14
   es'[ fis es' fis es' fis] |                             % bar 15
   g[ f!16 es]  d[ es d c]  bes,[ c bes, a,] |                      % bar 16
   g,8[ g bes g d' g] |                                         % bar 17
   g'[ f'16 es']  d'[ es' d' c']  bes[ c' bes a] |                      % bar 18
   ...
   bes,8[ d f d bes f] |                                         % bar 26
   d'16[ f' es' f']  d'[ f' es' f']  d'[ f' es' f'] |                      % bar 27
