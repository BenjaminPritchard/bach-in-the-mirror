...
voiceone =  
{  
g'8[ b' d'']  b'[ g' d'']  b'[ g' g''] |                     % bar 1
fis''4\prall d''8  a''[ fis'' d'']  a''[ fis'' d''] |            % bar 2
...
g'4.\mordent ~  g'8[ a' g']  fis'[ g' e'] |              % bar 9
...
d''4.\mordent r4. r4. |                              % bar 14
a'8[ cis'' e'']  cis''[ a' e'']  cis''[ a' g''] |               % bar 15
fis''4.\prall d'' r |                                  % bar 16
g'8[ b' d'']  b'[ g' d'']  b'[ g' f''] |                    % bar 17
e''[ c'' a']  a''[ e'' c'']  a'[ b' c''] |                       % bar 18
d''[ b' g']  g''[ d'' b']  g'[ a' b'] |                       % bar 19
c''2.\prall ~ c''4. ~|                                 % bar 20
c''2. ~ c''4. |                                        % bar 21
\tieUp b'2.\prall ~ b'4. ~ |                         % bar 22
b'2. ~ b'4. ~ |                                      % bar 23
b'8[ e'' d'']  c''[ d'' b']  a'[ b' g'] |                       % bar 24
a'[ c'' b']  a'[ b' g']  fis'[ g' e'] |                      % bar 25
fis'4\prall d'8 a'4\mordent fis'8 d''4\mordent fis'8 | % bar 26
g'8[ b' d'']  b'[ g' d'']  b'[ g' g''] |                     % bar 27
...
voicetwo =  
{
  ...
  d'4.\mordent ~  d'8[ d e]  fis[ e d] |              % bar 10
  ...
  cis'4.\prall a r |                                  % bar 15
  d8[ fis a]  fis[ d a]  fis[ d c'] |              % bar 16
  b4.\prall g r |                                    % bar 17
  c\mordent ~  c8[ d e]  fis,[ g, a,] |               % bar 18
  b,4.\mordent ~  b,8[ c d]  e,[ fis, g,] |              % bar 19
  ...
  e,4. ~ e,4 e8  fis[ e d] |                         % bar 30
  g4\mordent b,8  e[ d c] d4\mordent d,8 |           % bar 31
  g,4. ~  g,8[ b, d] g4.  \bar "|."                     % bar 32
}
